const [signUpButton, loginButton] = document.getElementById("new-user-content").getElementsByTagName("button");
const [signUpModal, loginModal] = document.getElementsByClassName("modals");
// const [closeSignUp, closeLogin] = document.getElementsByClassName("close-button");
const closeLogin = document.getElementsByClassName("close-button")[0];

const signUp = [signUpButton/*, closeSignUp*/], login = [loginButton, closeLogin]
